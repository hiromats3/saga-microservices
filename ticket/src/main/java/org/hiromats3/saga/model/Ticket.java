package org.hiromats3.saga.model;
...
public class Ticket {
    ...
    public String toString() {
        return "Ticket{id=" + id + ", orderId=" + orderId + ", state=" + state + ", accountId=" + accountId
                + ", name=" + name + ", numberOfPersons=" + numberOfPersons + ", totalCost=" + totalCost
                + ", lraId=" + lraId + '}';
    }
}